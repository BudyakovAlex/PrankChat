...
{
    public partial class DetailsOrderView : BaseGradientBarView<DetailsOrderViewModel>
    {
        protected override void SetupBinding()
        {
            var set = this.CreateBindingSet<DetailsOrderView, DetailsOrderViewModel>();
            ...
            set.Bind(unsubscriptionButton)
                .To(vm => vm.UnsubscribeTheOrderCommand)
                .Mode(MvxBindingMode.OneTime);
            ...
            set.Bind(executeVideoButton)
                .To(vm => vm.ExecuteTheOrderCommand)
                .Mode(MvxBindingMode.OneTime);

            set.Bind(cancelVideoButton)
                .To(vm => vm.CancelTheOrderCommand)
                .Mode(MvxBindingMode.OneTime);
