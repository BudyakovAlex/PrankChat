...
namespace PrankChat.Mobile.iOS.Controls
{
	partial class CompetitionView
	{
		...
		[Outlet]
		UIKit.UILabel onModerationLabel { get; set; }
		...
		[Outlet]
		UIKit.UIStackView termContainer { get; set; }

		[Outlet]
		UIKit.UILabel termFromLabel { get; set; }

		[Outlet]
		UIKit.UILabel termLabel { get; set; }

		[Outlet]
		UIKit.UILabel termToLabel { get; set; }
