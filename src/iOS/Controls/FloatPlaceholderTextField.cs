...
namespace PrankChat.Mobile.iOS.Controls
{
    ...
    public class FloatPlaceholderTextField : UITextField
    {
        ...
        {
            return base.TextRect(GetInsetRect(forBounds));
        }

        public override CGRect EditingRect(CGRect forBounds)
        {
            return base.EditingRect(GetInsetRect(forBounds));
        }
        ...
        private CGRect GetInsetRect(CGRect rect)
        {
            return new CGRect(rect.X + EdgeInsets.Left,
        ...
        private void TryInitializeBorder()
        {
            ...
            {
                BorderColor = Layer.BorderColor,
                Frame = new CGRect(Layer.Frame.Size.Width, 0, 1, Frame.Size.Height),
                BorderWidth = borderWidth
            };
