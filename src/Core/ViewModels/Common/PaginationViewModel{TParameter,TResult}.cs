...
{
    public abstract class PaginationViewModel<TParameter, TResult> : PaginationViewModelResult<TResult>, IMvxViewModel<GenericNavigationParams<TParameter>, GenericNavigationResult<TResult>>
    {
