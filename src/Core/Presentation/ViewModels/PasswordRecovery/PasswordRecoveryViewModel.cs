...
namespace PrankChat.Mobile.Core.Presentation.ViewModels.PasswordRecovery
{
    public class PasswordRecoveryViewModel : BasePageViewModel
    {
        ...
        private bool CheckValidation()
        {
            ...
            {
                ErrorHandleService.HandleException(new ValidationException(Resources.ValidationFieldEmail, ValidationErrorType.Empty));
            ...
            {
                ErrorHandleService.HandleException(new ValidationException(Resources.ValidationFieldEmail, ValidationErrorType.Invalid));
