...
namespace PrankChat.Mobile.Core.Infrastructure.Extensions
{
    ...
    {
        public static MvxRestrictedAsyncCommand CreateRestrictedCommand(this BaseViewModel viewModel,
                                                                        Func<Task> execute,
        ...
        public static MvxRestrictedCommand CreateRestrictedCommand(this BaseViewModel viewModel,
                                                                   Action execute,
                                                                   Func<bool>? canExecute = null,
                                                                   Func<bool>? restrictedCanExecute = null,
                                                                   Func<Task>? handleFunc = null,
        ...
        public static MvxCommand CreateCommand(this BaseViewModel viewModel,
                                               Action execute,
                                               Func<bool>? canExecute = null,
                                               bool useIsBusyWrapper = true,
                                               bool notifyIsBusyChanged = true)
        ...
        public static MvxCommand<T> CreateCommand<T>(this BaseViewModel viewModel,
                                                     Action<T> execute,
        ...
        public static MvxAsyncCommand CreateCommand(this BaseViewModel viewModel,
                                                    Func<Task> execute,
                                                    Func<bool>? canExecute = null,
                                                    bool useIsBusyWrapper = true,
                                                    bool notifyIsBusyChanged = true)
        ...
        public static MvxAsyncCommand<T> CreateCommand<T>(this BaseViewModel viewModel,
                                                          Func<T, Task> execute,
                                                          Func<T, bool>? canExecute = null,
                                                          bool useIsBusyWrapper = true,
                                                          bool notifyIsBusyChanged = true)
        ...
        private static Action WrapExecute(Action execute,
        ...
        private static Action<T> WrapExecute<T>(Action<T> execute,
                                                BaseViewModel viewModel,
                                                bool useIsBusyWrapper,
                                                bool notifyIsBusyChanged)
        {
        ...
        private static Func<Task> WrapExecute(Func<Task> execute,
                                              BaseViewModel viewModel,
                                              bool useIsBusyWrapper,
                                              bool notifyIsBusyChanged)
        {
        ...
        private static Func<T, Task> WrapExecute<T>(Func<T, Task> execute,
                                                    BaseViewModel viewModel,
                                                    bool useIsBusyWrapper,
                                                    bool notifyIsBusyChanged)
        {
