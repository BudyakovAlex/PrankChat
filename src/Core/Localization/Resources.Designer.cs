...
namespace PrankChat.Mobile.Core.Localization {
    ...
    public class Resources {
        ...
        /// </summary>
        public static string PerAll {
            get {
                return ResourceManager.GetString("PerAll", resourceCulture);
            }
        }
        ...
        ///Если задание невыполнимо, исполнитель может загрузить видео, в котором укажет причину, по которой невозможно снять видео, а заказчик п [остаток строки не уместился]&quot;;.
        /// </summary>
